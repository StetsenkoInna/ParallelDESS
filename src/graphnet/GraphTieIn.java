...
public class GraphTieIn extends GraphTie implements Serializable {
    ...
    public GraphTieIn(TieIn tiein){
        tie = tiein;
   
    }
    public TieIn getTieIn()
    {
    return tie;
    }
    ...
    public static ArrayList<TieIn> getTieInList() {  // added by Inna 1.11.2012
        
        ArrayList<TieIn> arrayTieIn = new ArrayList <>();
