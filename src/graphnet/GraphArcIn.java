...
public class GraphArcIn extends GraphArc implements Serializable {
    ...
    private static ArrayList<GraphArcIn> graphTieInList = new ArrayList<GraphArcIn>(); // added by Olha 24.09.12, cjrrect by Inna 28.11.2012
    private ArcIn tie;
    ...
    public static ArrayList<GraphArcIn> getGraphTieInList() {
        return graphTieInList;
    }
    public static ArrayList<ArcIn> getArcInList() {  // added by Inna 1.11.2012
        
        ArrayList<ArcIn> arrayTieIn = new ArrayList <>();
        for (GraphArcIn e: graphTieInList)
            arrayTieIn.add(e.getArcIn());
        return arrayTieIn;
    }
   ...
   public void setInf(boolean i){
    ...
    public static void addGraphTieInList(List<GraphArcIn> tieIn){ // added by Olha 14/11/2012
